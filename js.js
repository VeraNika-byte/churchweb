...
function generateCalendar() {
    ...
    for (let day = 1; day <= lastDayOfMonth.getDate(); day++) {
        ...
        // Přidání žlutého trojúhelníčku pro neděli
        if (date.getDay() === 0) {
            dayElement.classList.add('highlight');
            dayElement.title = `Mše svatá v 10:45`;
            dayElement.style.cursor = 'pointer'; // Změna kurzoru na pointer
            dayElement.innerHTML += '<div class="triangle"></div>'; // Přidání trojúhelníčku
